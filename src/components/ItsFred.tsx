export default function ItsFred() {
  return (
    <>
      <div className="relative flex h-3/4 lg:h-auto flex-col lg:flex-row justify-center mx-auto my-auto top-10 lg:top-1/4 lg:right-80">
        ...
        <div className="lg:top-1/4 lg:w-1/3 flex flex-col lg:text-left text-center">
          ...
          <p className="my-3 sm:text-2xl text-lg p-5">
