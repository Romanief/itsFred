export default function ItsFred() {
  return (
    <>
      <div className="absolute -top-[415px] hover:top-0 sm:right-0 -right-10 z-0 transition-all">
      ...
      <div className="w-full h-full">
        <div className="mx-auto sm:w-1/3 flex flex-col h-full sm:text-left text-center">
